def _get_table(table_name):
   ...
   from src.jguides_2024.time_and_trials.jguidera_relative_time_at_well import RelTimeWellSel, RelTimeWell, RelTimeDelaySel, RelTimeDelay, RelTimeWellPostDelaySel, RelTimeWellPostDelay
