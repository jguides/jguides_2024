...
def default_ave(**kwargs):
    resample_df = kwargs["resample_df"]
    resample_quantity = kwargs["resample_quantity"]
    return {"ave": np.mean(resample_df[resample_quantity])}
...
def hierarchical_bootstrap(
    ...
    print("Performing hierarchical bootstrap (flexible)...")
