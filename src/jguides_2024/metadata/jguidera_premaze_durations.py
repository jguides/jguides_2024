...
class PremazeDurations(dj.Manual):
    ...
    def insert_defaults(self, **kwargs):
        ...
        premaze_duration_dict = {
                                ...
                                "peanut20201105_.nwb": {"premaze_durations": [15, 15, 18, 13, 15, 15, 17, 21, 16],
                                                        "epochs": [2, 4, 6, 7, 9, 11, 13, 15, 17]},
                                "peanut20201106_.nwb": {"premaze_durations": [18, 18, 18, 18, 18, 15, 20, 18],
                                                        "epochs": np.arange(2, 17, 2)},
                                ...
                                "peanut20201110_.nwb": {"premaze_durations": [15, 13, 15, 12, 17, 14, 18, 20],
                                                        "epochs": np.arange(2, 17, 2)},
                                "peanut20201111_.nwb": {"premaze_durations": [15, 16, 33, 33, 17, 14, 19, 28],
                                                        "epochs": np.arange(2, 17, 2)},
                                "peanut20201112_.nwb": {"premaze_durations": [15, 18, 17, 19, 13, 19, 20, 15],
                                                        "epochs": np.arange(2, 17, 2)},
                                "peanut20201113_.nwb": {"premaze_durations": [17, 21, 26, 17, 21, 17, 19, 17],
                                                        "epochs": np.arange(2, 17, 2)},
                                "peanut20201114_.nwb": {"premaze_durations": [15, 16, 25, 15, 22, 24, 13, 13],
                                                        "epochs": np.arange(2, 17, 2)},
                                "peanut20201115_.nwb": {"premaze_durations": [18, 14, 19, 18, 12, 18, 15, 12],
                                                        "epochs": [2, 4, 6, 8, 10, 12, 15, 17]},
                                "peanut20201116_.nwb": {"premaze_durations": [15, 15, 13, 16, 15, 13, 21, 13, 16],
                                                        "epochs": [2, 4, 6, 8, 10, 12, 14, 15, 17]},
                                "peanut20201117_.nwb": {"premaze_durations": [13, 16, 15, 12, 15, 15, 12, 13],
                                                        "epochs": [2, 4, 6, 9, 11, 13, 15, 17]},
                                "peanut20201118_.nwb": {"premaze_durations": [19, 20, 15, 21, 13, 13, 26, 15],
                                                        "epochs": [2, 3, 5, 7, 9, 11, 13, 15]},
                                ...
                                "J1620210609_.nwb": {"premaze_durations": [17, 19, 16, 17, 15, 19, 18, 17],
                                                     "epochs": np.arange(2, 17, 2)},
                                "J1620210610_.nwb": {"premaze_durations": [17, 14, 21, 13, 20, 16, 16, 14],
                                                     "epochs": np.arange(2, 17, 2)},
                                ...
                                "J1620210617_.nwb": {"premaze_durations": [18, 20, 11, 20, 18, 15, 13, 16],
                                                     "epochs": np.arange(2, 17, 2)},
                                "J1620210618_.nwb": {"premaze_durations": [26, 30, 42, 19, 21, 36, 27, 23],
                                                     "epochs": [2, 4, 6, 8, 11, 13, 15, 17]},
                                "J1620210619_.nwb": {"premaze_durations": [15, 16, 18, 18, 17, 17, 16, 16],
                                                     "epochs": np.arange(2, 17, 2)},
                                "J1620210620_.nwb": {"premaze_durations": [16, 16, 19, 17, 23, 16, 17, 15],
                                                     "epochs": np.arange(2, 17, 2)},
                                ...
                                "fig20211105_.nwb": {"premaze_durations": [12, 17, 11, 10, 9, 11, 10, 9],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211106_.nwb": {"premaze_durations": [10, 11],
                                                     "epochs": [2, 4]},
                                "fig20211107_.nwb": {"premaze_durations": [13, 13, 12, 14, 12, 14, 13, 12],
                                                     "epochs": np.arange(2, 17, 2)},
                                ...
                                "fig20211111_.nwb": {"premaze_durations": [9, 20, 11, 9, 16, 9, 14, 10],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211112_.nwb": {"premaze_durations": [9, 12, 13, 13, 11, 8, 18, 22],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211113_.nwb": {"premaze_durations": [11, 10, 16, 15, 14, 12, 12, 11],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211114_.nwb": {"premaze_durations": [12, 12, 13, 26, 11, 12, 17, 10],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211115_.nwb": {"premaze_durations": [10, 14, 12, 9, 15, 11, 10, 14],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211116_.nwb": {"premaze_durations": [11, 12, 12, 12, 11, 16, 11, 11],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211117_.nwb": {"premaze_durations": [11, 11, 11, 15, 9, 10, 15, 12],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211118_.nwb": {"premaze_durations": [11, 12, 11, 11, 12, 13, 10, 18],
                                                     "epochs": np.arange(2, 17, 2)},
                                "fig20211119_.nwb": {"premaze_durations": [11, 12, 15, 10, 11, 13, 13, 9],
                                                     "epochs": np.arange(2, 17, 2)},
