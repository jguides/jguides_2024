...
params = {
    "populate_tables": populate_tables, "save_fig": save_fig, "path_fr_vec_param_name": "correct_incorrect_trials"}
...
params = {"populate_tables": populate_tables, "save_fig": save_fig, "yticks": yticks}
...
params = {"populate_tables": populate_tables, "save_fig": save_fig, "path_fr_vec_param_name":
          "correct_incorrect_trials", "ylim": [-.1, .5]}
params = _add_medium_sized_plot_params(params, extra_gaps=True)
params = _add_outbound_path_x_params(params)
...
params = {"populate_tables": populate_tables, "save_fig": save_fig, "path_fr_vec_param_name": "correct_incorrect_trials", "xlim": [0, .5],
          "ylim": [-.1, .3], "yticks": [0, .3]}
...
params = {"populate_tables": populate_tables, "save_fig": save_fig, "ylim": ylim, "yticks": yticks}
params = _add_medium_sized_plot_params(params, extra_gaps=True)
